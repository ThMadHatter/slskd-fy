...
import { Key, User, CornerDownLeft, CheckSquare, Square } from 'lucide-react';
...
export default function LoginView() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] flex flex-col items-center justify-center p-4 md:p-6 select-none font-sans overflow-y-auto">
      <div className="w-full max-w-md flex flex-col items-center gap-6 my-auto animate-fade-in-up">

        {/* SONIC Central Visual above card */}
        <SonicHeroVisual />
